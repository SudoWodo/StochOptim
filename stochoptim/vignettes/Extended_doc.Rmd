...
vignette: >
  %\VignetteIndexEntry{Extended_doc}
...
Each nested handles one single strategy and the list is named  
...
Nested list follows the naming convention :-  
<method_name>_strat_<strat_name>
